...
@pytest.fixture
def braga_faro():
    return SearchProblem(cidades_portugal,'Braga','Faro') # Define o caminho Braga Faro a testar
...
def test_exercicio6(braga_faro):
    ...
    assert t.search() == ['Braga', 'Porto', 'Agueda', 'Aveiro', 'Coimbra', 'Leiria', 'Castelo Branco', 'Santarem', 'Lisboa', 'Evora', 'Beja', 'Faro']
    assert round(t.avg_branching,2) == round((19+11-1)/11,2) # round é importante!
